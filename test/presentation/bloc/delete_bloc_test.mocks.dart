...
// in praktitask/test/presentation/bloc/delete_bloc_test.dart.
...
import 'package:praktitask/home/domain/usecase/delete_todo.dart' as _i4;
...
class MockDeleteTodoUsecase extends _i1.Mock implements _i4.DeleteTodoUsecase {
  ...
  @override
  _i5.Future<_i3.Either<_i3.Failure, int>> execute(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [id],
